...
if (RapidSub.canDelegate("completejob")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","415597574",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
Debug.ShouldStop(16);
_job.runClassMethod (ir.taravatgroup.shokrgozari.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
if (RapidSub.canDelegate("hc_responseerror")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("ir.taravatgroup.shokrgozari.httpjob");
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","415532039",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
if (RapidSub.canDelegate("hc_responsesuccess")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("ir.taravatgroup.shokrgozari.httpjob");
...
Debug.ShouldStop(1073741824);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","415400963",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
if (RapidSub.canDelegate("receiver_receive")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","receiver_receive", _firsttime, _startingintent);}
...
if (RapidSub.canDelegate("response_streamfinish")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
if (RapidSub.canDelegate("service_create")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","415073287",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","415073288",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
if (RapidSub.canDelegate("service_destroy")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_start", _startingintent);}
Debug.locals.put("StartingIntent", _startingintent);
...
if (RapidSub.canDelegate("submitjob")) { return ir.taravatgroup.shokrgozari.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.processBA,(Object)(_job.runClassMethod (ir.taravatgroup.shokrgozari.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 86;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
Debug.ShouldStop(2097152);
httputils2service._hc.runVoidMethod ("Execute",httputils2service.processBA,(Object)(_job.runClassMethod (ir.taravatgroup.shokrgozari.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid));
 };

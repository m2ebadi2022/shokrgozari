...
public class tamrin14_activity implements IRemote{
	public static tamrin14_activity mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public tamrin14_activity() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("tamrin14_activity"), "ir.taravatgroup.shokrgozari.tamrin14_activity");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, tamrin14_activity.class);
...
public static ir.taravatgroup.shokrgozari.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",tamrin14_activity.mostCurrent._activity,"book_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.book_activity.class),"do_tamrin_roz_layout",Debug.moduleToString(ir.taravatgroup.shokrgozari.do_tamrin_roz_layout.class),"download_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.download_activity.class),"et_mohebat1",tamrin14_activity.mostCurrent._et_mohebat1,"et_mohebat10",tamrin14_activity.mostCurrent._et_mohebat10,"et_mohebat2",tamrin14_activity.mostCurrent._et_mohebat2,"et_mohebat3",tamrin14_activity.mostCurrent._et_mohebat3,"et_mohebat4",tamrin14_activity.mostCurrent._et_mohebat4,"et_mohebat5",tamrin14_activity.mostCurrent._et_mohebat5,"et_mohebat6",tamrin14_activity.mostCurrent._et_mohebat6,"et_mohebat7",tamrin14_activity.mostCurrent._et_mohebat7,"et_mohebat8",tamrin14_activity.mostCurrent._et_mohebat8,"et_mohebat9",tamrin14_activity.mostCurrent._et_mohebat9,"HttpUtils2Service",Debug.moduleToString(ir.taravatgroup.shokrgozari.httputils2service.class),"intro_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.intro_activity.class),"Main",Debug.moduleToString(ir.taravatgroup.shokrgozari.main.class),"myFunc",Debug.moduleToString(ir.taravatgroup.shokrgozari.myfunc.class),"reagBook_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.reagbook_activity.class),"ScrollView1",tamrin14_activity.mostCurrent._scrollview1,"setting_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.setting_activity.class),"Starter",Debug.moduleToString(ir.taravatgroup.shokrgozari.starter.class),"tamrin_roz_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrin_roz_activity.class),"tamrin13_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrin13_activity.class),"tamrin16_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrin16_activity.class),"tamrin19_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrin19_activity.class),"tamrin25_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrin25_activity.class),"tamrin3_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrin3_activity.class),"tamrin8_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrin8_activity.class),"tamrinat_activity",Debug.moduleToString(ir.taravatgroup.shokrgozari.tamrinat_activity.class),"WebView1",tamrin14_activity.mostCurrent._webview1};
}
}
...
//C
this.state = 4;
 //BA.debugLineNum = 417;BA.debugLine="If(current_indexPage<>1)Then";
if (true) break;
...
//C
this.state = 13;
 //BA.debugLineNum = 418;BA.debugLine="btn_home_Click";
_btn_home_click();
 if (true) break;
...
//C
this.state = 9;
 //BA.debugLineNum = 421;BA.debugLine="Msgbox2Async(\"آیا از برنامه خارج میشوید!\", \"\",";
...
//C
this.state = 12;
 //BA.debugLineNum = 424;BA.debugLine="ExitApplication";
...
if (true) return "";
 ...
 //BA.debugLineNum = 210;BA.debugLine="this_day=29";
_this_day = (int) (29);
 //BA.debugLineNum = 211;BA.debugLine="lbl_show_tamrin_roz.TextSize=22";
mostCurrent._lbl_show_tamrin_roz.setTextSize((float) (22));
 //BA.debugLineNum = 212;BA.debugLine="lbl_show_tamrin_roz.Text=\"دفتر شکرگزاری\"";
...
String _color_str = "";
int _code_state = 0;
 //BA.debugLineNum = 298;BA.debugLine="Sub chek_state (id_roz As Int) As String";
 //BA.debugLineNum = 299;BA.debugLine="Dim color_str As String=\"\"";
_color_str = "";
 //BA.debugLineNum = 300;BA.debugLine="Dim code_state As Int = myFunc.get_State_tamrin1_";
_code_state = mostCurrent._myfunc._get_state_tamrin1_byroz /*int*/ (mostCurrent.activityBA,_id_roz);
 //BA.debugLineNum = 302;BA.debugLine="If(code_state=10)Then";
if ((_code_state==10)) { 
 //BA.debugLineNum = 303;BA.debugLine="color_str=0xFF66DF64";
_color_str = BA.NumberToString(((int)0xff66df64));
 }else if((_code_state==0)) { 
 //BA.debugLineNum = 305;BA.debugLine="color_str=0xFF919191";
_color_str = BA.NumberToString(((int)0xff919191));
 }else {
 //BA.debugLineNum = 307;BA.debugLine="color_str=0xFFDFCE64";
_color_str = BA.NumberToString(((int)0xffdfce64));
 };
 //BA.debugLineNum = 310;BA.debugLine="Return color_str";
if (true) return _color_str;
 //BA.debugLineNum = 311;BA.debugLine="End Sub";
return "";
}
public static String  _def_color_menu() throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Sub def_color_menu";
 //BA.debugLineNum = 237;BA.debugLine="btn_home.TextColor=Colors.Gray";
mostCurrent._btn_home.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 //BA.debugLineNum = 238;BA.debugLine="btn_all_tamrin.TextColor=Colors.Gray";
mostCurrent._btn_all_tamrin.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 //BA.debugLineNum = 239;BA.debugLine="btn_dashboard.TextColor=Colors.Gray";
...
int _counter_id = 0;
int _i = 0;
 //BA.debugLineNum = 243;BA.debugLine="Sub fill_list_tamrinat";
 //BA.debugLineNum = 244;BA.debugLine="Dim counter_id As Int=0";
_counter_id = (int) (0);
 //BA.debugLineNum = 245;BA.debugLine="For i=1 To 6";
{
final int step2 = 1;
final int limit2 = (int) (6);
_i = (int) (1) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 247;BA.debugLine="p = xui.CreatePanel(\"p\")";
mostCurrent._p = mostCurrent._xui.CreatePanel(processBA,"p");
 //BA.debugLineNum = 249;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, 100%x, 80dip)";
mostCurrent._p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (80)));
 //BA.debugLineNum = 250;BA.debugLine="p.LoadLayout(\"item_clv_tamrinat\")";
mostCurrent._p.LoadLayout("item_clv_tamrinat",mostCurrent.activityBA);
 //BA.debugLineNum = 253;BA.debugLine="clv_tamrinat_tagvim.Add(p,i)";
...
_counter_id = (int) (_counter_id+1);
 //BA.debugLineNum = 256;BA.debugLine="L1.Text=counter_id";
mostCurrent._l1.setText(BA.ObjectToCharSequence(_counter_id));
 //BA.debugLineNum = 257;BA.debugLine="r1.Tag=counter_id";
mostCurrent._r1.setTag((Object)(_counter_id));
 //BA.debugLineNum = 258;BA.debugLine="r1.Color=chek_state(counter_id)";
...
_counter_id = (int) (_counter_id+1);
 //BA.debugLineNum = 261;BA.debugLine="L2.Text=counter_id";
mostCurrent._l2.setText(BA.ObjectToCharSequence(_counter_id));
 //BA.debugLineNum = 262;BA.debugLine="r2.Tag=counter_id";
mostCurrent._r2.setTag((Object)(_counter_id));
 //BA.debugLineNum = 263;BA.debugLine="r2.Color=chek_state(counter_id)";
...
_counter_id = (int) (_counter_id+1);
 //BA.debugLineNum = 266;BA.debugLine="L3.Text=counter_id";
mostCurrent._l3.setText(BA.ObjectToCharSequence(_counter_id));
 //BA.debugLineNum = 267;BA.debugLine="r3.Tag=counter_id";
mostCurrent._r3.setTag((Object)(_counter_id));
 //BA.debugLineNum = 268;BA.debugLine="r3.Color=chek_state(counter_id)";
mostCurrent._r3.setColor((int)(Double.parseDouble(_chek_state(_counter_id))));
 //BA.debugLineNum = 270;BA.debugLine="counter_id=counter_id+1";
_counter_id = (int) (_counter_id+1);
 //BA.debugLineNum = 271;BA.debugLine="L4.Text=counter_id";
mostCurrent._l4.setText(BA.ObjectToCharSequence(_counter_id));
 //BA.debugLineNum = 272;BA.debugLine="r4.Tag=counter_id";
mostCurrent._r4.setTag((Object)(_counter_id));
 //BA.debugLineNum = 273;BA.debugLine="r4.Color=chek_state(counter_id)";
mostCurrent._r4.setColor((int)(Double.parseDouble(_chek_state(_counter_id))));
 //BA.debugLineNum = 275;BA.debugLine="counter_id=counter_id+1";
_counter_id = (int) (_counter_id+1);
 //BA.debugLineNum = 276;BA.debugLine="L5.Text=counter_id";
mostCurrent._l5.setText(BA.ObjectToCharSequence(_counter_id));
 //BA.debugLineNum = 277;BA.debugLine="r5.Tag=counter_id";
mostCurrent._r5.setTag((Object)(_counter_id));
 //BA.debugLineNum = 278;BA.debugLine="r5.Color=chek_state(counter_id)";
mostCurrent._r5.setColor((int)(Double.parseDouble(_chek_state(_counter_id))));
 //BA.debugLineNum = 280;BA.debugLine="If(i=6)Then";
if ((_i==6)) { 
 //BA.debugLineNum = 281;BA.debugLine="r4.Visible=False";
mostCurrent._r4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 282;BA.debugLine="r5.Visible=False";
...
//C
this.state = 1;
 //BA.debugLineNum = 315;BA.debugLine="lsv_roz.Clear";
parent.mostCurrent._lsv_roz.Clear();
 //BA.debugLineNum = 316;BA.debugLine="lsv_roz.TwoLinesLayout.Label.Width=90%x";
parent.mostCurrent._lsv_roz.getTwoLinesLayout().Label.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA));
 //BA.debugLineNum = 317;BA.debugLine="lsv_roz.TwoLinesLayout.Label.TextColor=Colors.Gre";
parent.mostCurrent._lsv_roz.getTwoLinesLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Green);
 //BA.debugLineNum = 319;BA.debugLine="lsv_roz.TwoLinesLayout.SecondLabel.Width=90%x";
parent.mostCurrent._lsv_roz.getTwoLinesLayout().SecondLabel.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA));
 //BA.debugLineNum = 321;BA.debugLine="lbl_roz_lsv.Text=\"روز \"&id";
parent.mostCurrent._lbl_roz_lsv.setText(BA.ObjectToCharSequence("روز "+BA.NumberToString(_id)));
 //BA.debugLineNum = 322;BA.debugLine="Dim strFunc As StringFunctions";
_strfunc = new adr.stringfunctions.stringfunctions();
 //BA.debugLineNum = 323;BA.debugLine="strFunc.Initialize";
_strfunc._initialize(processBA);
 //BA.debugLineNum = 326;BA.debugLine="Dim ls_tamrin1_Roz As List";
_ls_tamrin1_roz = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 327;BA.debugLine="ls_tamrin1_Roz.Initialize";
_ls_tamrin1_roz.Initialize();
 //BA.debugLineNum = 328;BA.debugLine="ls_tamrin1_Roz=myFunc.get_tamrin1_byRoz(id)";
_ls_tamrin1_roz = parent.mostCurrent._myfunc._get_tamrin1_byroz /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA,_id);
 //BA.debugLineNum = 330;BA.debugLine="For i=0 To ls_tamrin1_Roz.Size-1";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 332;BA.debugLine="Dim list_num As List";
_list_num = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 333;BA.debugLine="list_num.Initialize";
_list_num.Initialize();
 //BA.debugLineNum = 334;BA.debugLine="list_num=strFunc.Split(ls_tamrin1_Roz.Get(i) , \"";
_list_num = _strfunc._vvvvvv5(BA.ObjectToString(_ls_tamrin1_roz.Get(_i)),"@");
 //BA.debugLineNum = 336;BA.debugLine="If(list_num.Get(2)<>\"null\"  And list_num.Get(2)<";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 338;BA.debugLine="lsv_roz.AddTwoLines((i+1)&\" : \"&list_num.Get(2)";
...
if (true) break;
;
 //BA.debugLineNum = 343;BA.debugLine="If(lsv_roz.Size=0)Then";
...
//C
this.state = 11;
 //BA.debugLineNum = 345;BA.debugLine="lbl_back_lsv_Click";
_lbl_back_lsv_click();
 //BA.debugLineNum = 347;BA.debugLine="Msgbox2Async(\"اطلاعاتی ثبت نشده است!\", \"\", \"باشه";
...
public static String  _lbl_back_lsv_click() throws Exception{
 //BA.debugLineNum = 405;BA.debugLine="Private Sub lbl_back_lsv_Click";
 //BA.debugLineNum = 406;BA.debugLine="pan_all_lsv.Visible=False";
mostCurrent._pan_all_lsv.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 407;BA.debugLine="End Sub";
return "";
}
public static String  _pan_all_lsv_click() throws Exception{
 //BA.debugLineNum = 401;BA.debugLine="Private Sub pan_all_lsv_Click";
...
String _url = "";
 //BA.debugLineNum = 462;BA.debugLine="Private Sub pan_comment_Click";
 //BA.debugLineNum = 463;BA.debugLine="Try";
try { //BA.debugLineNum = 464;BA.debugLine="Dim market As Intent";
_market = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 465;BA.debugLine="Dim url As String";
_url = "";
 //BA.debugLineNum = 466;BA.debugLine="url=\"bazaar://details?id=ir.taravatgroup.ezafeka";
_url = "bazaar://details?id=ir.taravatgroup.ezafekari2";
 //BA.debugLineNum = 467;BA.debugLine="market.Initialize(market.ACTION_EDIT,url)";
_market.Initialize(_market.ACTION_EDIT,_url);
 //BA.debugLineNum = 468;BA.debugLine="StartActivity(market)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_market.getObject()));
 } 
       catch (Exception e8) {
			processBA.setLastException(e8); //BA.debugLineNum = 472;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("01769482",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
String _url = "";
 //BA.debugLineNum = 484;BA.debugLine="Private Sub pan_donate_Click";
 //BA.debugLineNum = 485;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 486;BA.debugLine="Dim url As String=\"https://zarinp.al/taravatgroup";
_url = "https://zarinp.al/taravatgroup";
 //BA.debugLineNum = 487;BA.debugLine="i.Initialize(i.ACTION_VIEW, url)";
_i.Initialize(_i.ACTION_VIEW,_url);
 //BA.debugLineNum = 488;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_i.getObject()));
 //BA.debugLineNum = 489;BA.debugLine="End Sub";
return "";
}
public static String  _pan_download_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Private Sub pan_download_Click";
 //BA.debugLineNum = 224;BA.debugLine="StartActivity(download_activity)";
...
public static String  _pan_info_click() throws Exception{
 //BA.debugLineNum = 480;BA.debugLine="Private Sub pan_info_Click";
 //BA.debugLineNum = 481;BA.debugLine="Msgbox(\"گروه برنامه نویسی طراوت\"&CRLF&\"v1.0\"&CRLF";
...
anywheresoftware.b4a.objects.IntentWrapper _market = null;
String _url = "";
 //BA.debugLineNum = 444;BA.debugLine="Private Sub pan_otherMyApps_Click";
 //BA.debugLineNum = 445;BA.debugLine="Try";
try { //BA.debugLineNum = 446;BA.debugLine="Dim market As Intent";
_market = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 447;BA.debugLine="Dim url As String";
_url = "";
 //BA.debugLineNum = 448;BA.debugLine="url=\"bazaar://collection?slug=by_author&aid=4074";
_url = "bazaar://collection?slug=by_author&aid=407437645137";
 //BA.debugLineNum = 449;BA.debugLine="market.Initialize(market.ACTION_VIEW,url)";
_market.Initialize(_market.ACTION_VIEW,_url);
 //BA.debugLineNum = 450;BA.debugLine="StartActivity(market)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(_market.getObject()));
 } 
       catch (Exception e8) {
			processBA.setLastException(e8); //BA.debugLineNum = 454;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("01703946",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 460;BA.debugLine="End Sub";
return "";
}
public static String  _pan_setting_click() throws Exception{
 //BA.debugLineNum = 227;BA.debugLine="Private Sub pan_setting_Click";
 //BA.debugLineNum = 229;BA.debugLine="StartActivity(setting_activity)";
...
public static String  _pan_splash_click() throws Exception{
 //BA.debugLineNum = 440;BA.debugLine="Private Sub pan_splash_Click";
 //BA.debugLineNum = 442;BA.debugLine="End Sub";
return "";
}
public static String  _pan_tamrin_roz_click() throws Exception{
 //BA.debugLineNum = 491;BA.debugLine="Private Sub pan_tamrin_roz_Click";
 //BA.debugLineNum = 493;BA.debugLine="If(this_day=29)Then";
if ((_this_day==29)) { 
 //BA.debugLineNum = 495;BA.debugLine="StartActivity(daftar_activity)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._daftar_activity.getObject()));
 }else {
 //BA.debugLineNum = 498;BA.debugLine="current_roz_tamrin=this_day";
_current_roz_tamrin = _this_day;
 //BA.debugLineNum = 499;BA.debugLine="StartActivity(tamrin_roz_activity)";
...
anywheresoftware.b4a.objects.PanelWrapper _pan_r = null;
 //BA.debugLineNum = 391;BA.debugLine="Private Sub r1_Click";
 //BA.debugLineNum = 393;BA.debugLine="Dim pan_r As Panel=Sender";
...
_pan_r = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 395;BA.debugLine="pan_all_lsv.Visible=True";
mostCurrent._pan_all_lsv.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 396;BA.debugLine="get_tamrin1_for_lsv(pan_r.Tag)";
...
anywheresoftware.b4a.objects.PanelWrapper _pan_r = null;
 //BA.debugLineNum = 384;BA.debugLine="Private Sub r2_Click";
 //BA.debugLineNum = 385;BA.debugLine="Dim pan_r As Panel=Sender";
_pan_r = new anywheresoftware.b4a.objects.PanelWrapper();
_pan_r = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 387;BA.debugLine="pan_all_lsv.Visible=True";
mostCurrent._pan_all_lsv.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 388;BA.debugLine="get_tamrin1_for_lsv(pan_r.Tag)";
_get_tamrin1_for_lsv((int)(BA.ObjectToNumber(_pan_r.getTag())));
...
anywheresoftware.b4a.objects.PanelWrapper _pan_r = null;
 //BA.debugLineNum = 377;BA.debugLine="Private Sub r3_Click";
 //BA.debugLineNum = 378;BA.debugLine="Dim pan_r As Panel=Sender";
_pan_r = new anywheresoftware.b4a.objects.PanelWrapper();
_pan_r = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 380;BA.debugLine="pan_all_lsv.Visible=True";
mostCurrent._pan_all_lsv.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 381;BA.debugLine="get_tamrin1_for_lsv(pan_r.Tag)";
_get_tamrin1_for_lsv((int)(BA.ObjectToNumber(_pan_r.getTag())));
...
anywheresoftware.b4a.objects.PanelWrapper _pan_r = null;
 //BA.debugLineNum = 368;BA.debugLine="Private Sub r4_Click";
 //BA.debugLineNum = 369;BA.debugLine="Dim pan_r As Panel=Sender";
_pan_r = new anywheresoftware.b4a.objects.PanelWrapper();
_pan_r = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 371;BA.debugLine="pan_all_lsv.Visible=True";
mostCurrent._pan_all_lsv.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 372;BA.debugLine="get_tamrin1_for_lsv(pan_r.Tag)";
_get_tamrin1_for_lsv((int)(BA.ObjectToNumber(_pan_r.getTag())));
...
anywheresoftware.b4a.objects.PanelWrapper _pan_r = null;
 //BA.debugLineNum = 360;BA.debugLine="Private Sub r5_Click";
 //BA.debugLineNum = 361;BA.debugLine="Dim pan_r As Panel=Sender";
_pan_r = new anywheresoftware.b4a.objects.PanelWrapper();
_pan_r = (anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 363;BA.debugLine="pan_all_lsv.Visible=True";
mostCurrent._pan_all_lsv.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 364;BA.debugLine="get_tamrin1_for_lsv(pan_r.Tag)";
_get_tamrin1_for_lsv((int)(BA.ObjectToNumber(_pan_r.getTag())));

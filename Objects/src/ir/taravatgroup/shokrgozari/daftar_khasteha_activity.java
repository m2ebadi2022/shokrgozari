...
public class daftar_khasteha_activity extends Activity implements B4AActivity{
	public static daftar_khasteha_activity mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.taravatgroup.shokrgozari", "ir.taravatgroup.shokrgozari.daftar_khasteha_activity");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (daftar_khasteha_activity).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.taravatgroup.shokrgozari", "ir.taravatgroup.shokrgozari.daftar_khasteha_activity");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.taravatgroup.shokrgozari.daftar_khasteha_activity", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (daftar_khasteha_activity) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (daftar_khasteha_activity) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return daftar_khasteha_activity.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (daftar_khasteha_activity) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (daftar_khasteha_activity) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            daftar_khasteha_activity mc = mostCurrent;
...
public anywheresoftware.b4a.objects.EditTextWrapper _et_khaste = null;
...
public static String  _et_khaste_textchanged(String _old,String _new) throws Exception{
anywheresoftware.b4a.objects.EditTextWrapper _this_num_tamrin = null;
 //BA.debugLineNum = 111;BA.debugLine="Private Sub et_khaste_TextChanged (Old As String,";
...
_this_num_tamrin = (anywheresoftware.b4a.objects.EditTextWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.EditTextWrapper(), (android.widget.EditText)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 115;BA.debugLine="If(et_khaste.Text<>\"\" Or et_khaste.Text<>Null)Th";
if (((mostCurrent._et_khaste.getText()).equals("") == false || mostCurrent._et_khaste.getText()!= null)) { 
 //BA.debugLineNum = 116;BA.debugLine="myFunc.update_daftar_khasteha(this_num_tamrin.T";
mostCurrent._myfunc._update_daftar_khasteha /*boolean*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(_this_num_tamrin.getTag())),_this_num_tamrin.getText(),(int) (1));
 };
 };
...
_ls_tamrin1_roz.Initialize();
 //BA.debugLineNum = 62;BA.debugLine="ls_tamrin1_Roz=myFunc.get_daftar_khasteha_byShena";
_ls_tamrin1_roz = mostCurrent._myfunc._get_daftar_khasteha_byshenase /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA,mostCurrent._main._daftar_shenase /*String*/ );
 //BA.debugLineNum = 65;BA.debugLine="lbl_tamrin_roz.Text=myFunc.get_daftar_shenase_tit";
mostCurrent._lbl_tamrin_roz.setText(BA.ObjectToCharSequence(mostCurrent._myfunc._get_daftar_shenase_titel /*String*/ (mostCurrent.activityBA,mostCurrent._main._daftar_shenase /*String*/ )));
 //BA.debugLineNum = 67;BA.debugLine="For i=0 To ls_tamrin1_Roz.Size-1";
{
final int step9 = 1;
final int limit9 = (int) (_ls_tamrin1_roz.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit9 ;_i = _i + step9 ) {
 //BA.debugLineNum = 69;BA.debugLine="p = xui.CreatePanel(\"p\")";
mostCurrent._p = mostCurrent._xui.CreatePanel(processBA,"p");
 //BA.debugLineNum = 70;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, 100%x, 146dip)";
mostCurrent._p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (146)));
 //BA.debugLineNum = 71;BA.debugLine="p.LoadLayout(\"item_list_daftar_khasteha\")";
mostCurrent._p.LoadLayout("item_list_daftar_khasteha",mostCurrent.activityBA);
 //BA.debugLineNum = 73;BA.debugLine="et_khaste.Color=Colors.White";
mostCurrent._et_khaste.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 76;BA.debugLine="CustomLV_tamrin.Add(p,i)";
mostCurrent._customlv_tamrin._add(mostCurrent._p,(Object)(_i));
 //BA.debugLineNum = 79;BA.debugLine="Dim list_num As List";
_list_num = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 80;BA.debugLine="list_num.Initialize";
_list_num.Initialize();
 //BA.debugLineNum = 81;BA.debugLine="list_num=strFunc.Split(ls_tamrin1_Roz.Get(i) , \"";
_list_num = _strfunc._vvvvvv5(BA.ObjectToString(_ls_tamrin1_roz.Get(_i)),"@");
 //BA.debugLineNum = 84;BA.debugLine="lbl_num.Tag=list_num.Get(0)";
mostCurrent._lbl_num.setTag(_list_num.Get((int) (0)));
 //BA.debugLineNum = 85;BA.debugLine="lbl_num.Text=i+1";
mostCurrent._lbl_num.setText(BA.ObjectToCharSequence(_i+1));
 //BA.debugLineNum = 87;BA.debugLine="If(list_num.Get(2)<>\"null\")Then";
if (((_list_num.Get((int) (2))).equals((Object)("null")) == false)) { 
 //BA.debugLineNum = 88;BA.debugLine="et_khaste.Text=list_num.Get(2)";
mostCurrent._et_khaste.setText(BA.ObjectToCharSequence(_list_num.Get((int) (2))));
 };
 //BA.debugLineNum = 92;BA.debugLine="et_khaste.Tag=list_num.Get(0)";
mostCurrent._et_khaste.setTag(_list_num.Get((int) (0)));
 }
};
 //BA.debugLineNum = 100;BA.debugLine="list_reload=0";
_list_reload = (int) (0);
...
mostCurrent._lbl_num = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private et_khaste As EditText";
mostCurrent._et_khaste = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private lbl_tamrin_roz As Label";
mostCurrent._lbl_tamrin_roz = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private lbl_add_new As Label";
mostCurrent._lbl_add_new = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Dim list_reload As Int=0";
_list_reload = (int) (0);
 //BA.debugLineNum = 32;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_add_new_click() throws Exception{
 //BA.debugLineNum = 137;BA.debugLine="Private Sub lbl_add_new_Click";
 //BA.debugLineNum = 139;BA.debugLine="myFunc.connection_sql";
mostCurrent._myfunc._connection_sql /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 140;BA.debugLine="Main.sql.ExecNonQuery2(\"INSERT INTO daftar_khaste";
mostCurrent._main._sql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2("INSERT INTO daftar_khasteha ('shenase') VALUES (?)",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(mostCurrent._main._daftar_shenase /*String*/ )}));
 //BA.debugLineNum = 141;BA.debugLine="Main.sql.Close";
mostCurrent._main._sql /*anywheresoftware.b4a.sql.SQL*/ .Close();
 //BA.debugLineNum = 142;BA.debugLine="ToastMessageShow(\"اضافه شد\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("اضافه شد"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 144;BA.debugLine="fill_list";
_fill_list();
 //BA.debugLineNum = 146;BA.debugLine="End Sub";
return "";
}
public static String  _lbl_back_click() throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Private Sub lbl_back_Click";
...
public ResumableSub_lbl_num_LongClick(ir.taravatgroup.shokrgozari.daftar_khasteha_activity parent) {
this.parent = parent;
}
ir.taravatgroup.shokrgozari.daftar_khasteha_activity parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 150;BA.debugLine="Dim this_item As Label=Sender";
...
_this_item = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 153;BA.debugLine="Msgbox2Async(\"مطمئن هستید که این مورد حذف شود؟\",";
...
//C
this.state = 4;
 //BA.debugLineNum = 156;BA.debugLine="myFunc.delet_daftar_khasteById(this_item.Tag)";
parent.mostCurrent._myfunc._delet_daftar_khastebyid /*String*/ (mostCurrent.activityBA,(int)(BA.ObjectToNumber(_this_item.getTag())));
 //BA.debugLineNum = 157;BA.debugLine="fill_list";
_fill_list();
 if (true) break;

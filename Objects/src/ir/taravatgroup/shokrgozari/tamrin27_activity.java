...
public class tamrin27_activity extends Activity implements B4AActivity{
	public static tamrin27_activity mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.taravatgroup.shokrgozari", "ir.taravatgroup.shokrgozari.tamrin27_activity");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tamrin27_activity).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.taravatgroup.shokrgozari", "ir.taravatgroup.shokrgozari.tamrin27_activity");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.taravatgroup.shokrgozari.tamrin27_activity", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tamrin27_activity) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tamrin27_activity) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return tamrin27_activity.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (tamrin27_activity) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (tamrin27_activity) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            tamrin27_activity mc = mostCurrent;
...
int _i = 0;
 ...
 //BA.debugLineNum = 32;BA.debugLine="Activity.LoadLayout(\"tamrin27_layout\")";
mostCurrent._activity.LoadLayout("tamrin27_layout",mostCurrent.activityBA);
...
_ls_get_content.Initialize();
 //BA.debugLineNum = 38;BA.debugLine="ls_get_content=myFunc.get_all_tamrin27";
_ls_get_content = mostCurrent._myfunc._get_all_tamrin27 /*anywheresoftware.b4a.objects.collections.List*/ (mostCurrent.activityBA);
...
public static String  _et_mohebat1_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 109;BA.debugLine="myFunc.update_tamrin27(1,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (1),_new);
...
public static String  _et_mohebat10_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 73;BA.debugLine="myFunc.update_tamrin27(10,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (10),_new);
...
public static String  _et_mohebat2_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 105;BA.debugLine="myFunc.update_tamrin27(2,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (2),_new);
...
public static String  _et_mohebat3_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 101;BA.debugLine="myFunc.update_tamrin27(3,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (3),_new);
...
public static String  _et_mohebat4_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 97;BA.debugLine="myFunc.update_tamrin27(4,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (4),_new);
...
public static String  _et_mohebat5_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 93;BA.debugLine="myFunc.update_tamrin27(5,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (5),_new);
...
public static String  _et_mohebat6_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 89;BA.debugLine="myFunc.update_tamrin27(6,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (6),_new);
...
public static String  _et_mohebat7_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 85;BA.debugLine="myFunc.update_tamrin27(7,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (7),_new);
...
public static String  _et_mohebat8_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 81;BA.debugLine="myFunc.update_tamrin27(8,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (8),_new);
...
public static String  _et_mohebat9_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 77;BA.debugLine="myFunc.update_tamrin27(9,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (9),_new);
...
public static String  _et_moshkel_textchanged(String _old,String _new) throws Exception{
 ...
 //BA.debugLineNum = 113;BA.debugLine="myFunc.update_tamrin27(11,New)";
mostCurrent._myfunc._update_tamrin27 /*boolean*/ (mostCurrent.activityBA,(int) (11),_new);

...
anywheresoftware.b4a.keywords.Common.LogImpl("227262982","HttpUtils2Service: job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("227197442",("ResponseError. Reason: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_reason))+", Response: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_response.getErrorResponse()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("227197447","HttpUtils2Service (hc_ResponseError): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("227066371","HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("226738695",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("226738696","Switching to File.DirInternal",0);

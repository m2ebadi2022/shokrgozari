...
Sub Activity_Create(FirstTime As Boolean)
	...
	Activity.LoadLayout("tamrin25_layout")
	...
	If(File.Exists(File.DirInternal,"pic_tamrin25_1.jpg"))Then
		pan_upload_pic1.SetBackgroundImage(LoadBitmapSample(File.DirInternal,"pic_tamrin25_1.jpg",120dip,120dip))
	End If
	If(File.Exists(File.DirInternal,"pic_tamrin25_2.jpg"))Then
		pan_upload_pic2.SetBackgroundImage(LoadBitmapSample(File.DirInternal,"pic_tamrin25_2.jpg",120dip,120dip))
	End If
	If(File.Exists(File.DirInternal,"pic_tamrin25_3.jpg"))Then
		pan_upload_pic3.SetBackgroundImage(LoadBitmapSample(File.DirInternal,"pic_tamrin25_3.jpg",120dip,120dip))
	End If
	...
	If Success Then
		...
		Select pic_upload_index
			Case 1
				...
				File.Copy(Dir,FileName,File.DirInternal,"pic_tamrin25_1.jpg")
			Case 2
				pan_upload_pic2.SetBackgroundImage(LoadBitmapSample(Dir,FileName,120dip,120dip))
				File.Copy(Dir,FileName,File.DirInternal,"pic_tamrin25_2.jpg")
			Case 3
				pan_upload_pic3.SetBackgroundImage(LoadBitmapSample(Dir,FileName,120dip,120dip))
				File.Copy(Dir,FileName,File.DirInternal,"pic_tamrin25_3.jpg")
...
Private Sub pan_upload_pic3_Click
	...
	If(File.Exists(File.DirInternal,"pic_tamrin25_3.jpg"))Then
		...
		pan_showPic.SetBackgroundImage(LoadBitmapSample(File.DirInternal,"pic_tamrin25_3.jpg",120dip,120dip))
	Else
...
Private Sub pan_upload_pic2_Click
	...
	If(File.Exists(File.DirInternal,"pic_tamrin25_2.jpg"))Then
		pan_all_showPic.Visible=True
		pan_showPic.SetBackgroundImage(LoadBitmapSample(File.DirInternal,"pic_tamrin25_2.jpg",120dip,120dip))
	Else
		Chooser.Show("image/*", "Select an image")
	End If
...
Private Sub pan_upload_pic1_Click
	...
	If(File.Exists(File.DirInternal,"pic_tamrin25_1.jpg"))Then
		pan_all_showPic.Visible=True
		pan_showPic.SetBackgroundImage(LoadBitmapSample(File.DirInternal,"pic_tamrin25_1.jpg",120dip,120dip))
	Else
		Chooser.Show("image/*", "Select an image")
	End If
